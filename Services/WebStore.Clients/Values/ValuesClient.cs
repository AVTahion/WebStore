...
namespace WebStore.Clients.Values
{
    public class ValuesClient : BaseClient, IValuesService
    {
        ...
        public async Task<HttpStatusCode> DeleteAsync(int id) => (await _Client.DeleteAsync($"{_ServiceAddress}/delete/id")).StatusCode;
        ...
        {
            var responce = await _Client.PutAsJsonAsync($"{_ServiceAddress}/put/{id}", value);
