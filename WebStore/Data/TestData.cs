...
namespace WebStore.Data
{
    public static class TestData
    {
        ...
        {
            new Brand {Id = 1, Name = "Рога&Копыта", Order = 0},
            new Brand {Id = 2, Name = "Рита", Order = 1},
            new Brand {Id = 3, Name = "Abibase", Order = 2},
            new Brand {Id = 4, Name = "Шефф", Order = 3},
            new Brand {Id = 5, Name = "Буквы", Order = 4},
            new Brand {Id = 6, Name = "СуперБрэнд", Order = 5},
            new Brand {Id = 7, Name = "НоуНейм", Order = 6},
        };
